...
public class Hero extends FlyingObject {
    ...
    public Hero() {
        life = 3;
        doubleFire = 0;
        this.image = MyFrame.hero0;
        this.ember = MyFrame.heroEmber;
        images = new BufferedImage[] { MyFrame.hero0, MyFrame.hero1 };
    ...
    public boolean outOfBounds() {
        return x < 0 || x > MyFrame.WIDTH - width
                || y < 0 || y > MyFrame.HEIGHT - height;
    }
